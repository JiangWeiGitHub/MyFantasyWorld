...
namespace jiangweigithub {
  ...
  cocos2d::Layer* ProtagonistLayer::getProtagonistLayer()
  {
    auto tmp = ProtagonistLayer::create();

    return tmp;
  }

  bool ProtagonistLayer::init()
  {
    if(!Layer::init())
    {
      return false;
    ...
    listener->onKeyPressed = CC_CALLBACK_2(ProtagonistLayer::onKeyPressed, this);
    listener->onKeyReleased = CC_CALLBACK_2(ProtagonistLayer::onKeyReleased, this);
    ...
    contactListener->onContactBegin = CC_CALLBACK_1(ProtagonistLayer::onContactBegin, this);
    contactListener->onContactSeparate = CC_CALLBACK_1(ProtagonistLayer::onContactSeparate, this);
  ...
  void ProtagonistLayer::update(float delta)
  {
  ...
  void ProtagonistLayer::onKeyPressed(cocos2d::EventKeyboard::KeyCode keyCode, cocos2d::Event* event)
  {
    switch((int)keyCode)
    {
      case 28:
  ...
  void ProtagonistLayer::onKeyReleased(cocos2d::EventKeyboard::KeyCode keyCode, cocos2d::Event* event)
  {
    switch((int)keyCode)
    {
      case 28:
    ...
    //                                         "CloseNormal.png",
    //                                         "CloseSelected.png",
    //                                         CC_CALLBACK_1(ProtagonistLayer::_nextStringCallback, this));
  ...
  bool ProtagonistLayer::onContactBegin(const cocos2d::PhysicsContact& contact)
  {
  ...
  bool ProtagonistLayer::onContactSeparate(const cocos2d::PhysicsContact& contact)
  {
    this->_calculateContactPixel(contact);
  ...
  bool ProtagonistLayer::_calculateContactPixel(const cocos2d::PhysicsContact& contact)
  {
